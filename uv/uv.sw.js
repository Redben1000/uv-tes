    ...
    class i extends e.EventEmitter {
        ...
        async fetch({request: i}) {
            ...
            try {
                ...
                d.headers["user-agent"] = "Mozilla/5.0 (Windows NT 10.0; WOW64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.5666.197 Safari/537.36",
